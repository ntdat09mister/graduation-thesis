...
<template>
    <div class="flex flex-col justify-center items-center">
        ...
        <div class="flex flex-col justify-around items-center h-[200px]">
            <input class="w-[590px] h-[38px] text-[15px] rounded-xl focus:outline-none border border-gray-300 " type="text"
                placeholder="Nhập username.....">
            <input class="w-[590px] h-[38px] text-[15px] rounded-xl focus:outline-none border border-gray-300 " type="password"
