<template>
    <svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <defs></defs>
        <g id="57.-Exchange" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round"
            ...
            <path
                ...
                id="Layer-1" stroke="#222F3E" stroke-width="4" fill-rule="nonzero"></path>
            <path
            ...
            id="Layer-2" stroke="#222F3E" stroke-width="4" fill-rule="nonzero"
            transform="translate(48.638298, 72.595745) scale(-1, -1) translate(-48.638298, -72.595745) "></path>
    </g>
</svg></template>