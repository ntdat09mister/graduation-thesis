...
-- Dumping data for table danny-store-db.cart: ~15 rows (approximately)
...
-- Dumping data for table danny-store-db.cart_detail: ~15 rows (approximately)
...
-- Dumping data for table danny-store-db.order: ~14 rows (approximately)
REPLACE INTO `order` (`id`, `created_at`, `customer_id`, `modified_at`, `sale_staff_id`, `status_id`, `total_amount`) VALUES
	...
	(2, '2023-11-07 15:53:19', 6, NULL, 2, 1, 3000),
	(3, '2023-11-08 15:53:38', 6, NULL, 2, 1, 5412),
	(6, '2023-11-09 13:07:34', 4, NULL, 1, 2, 6696),
	(7, '2023-11-09 13:44:34', 4, NULL, 1, 1, 6875),
	(8, '2023-11-09 13:48:39', 4, NULL, 1, 3, 3750),
	(9, '2023-11-09 13:52:37', 7, NULL, 1, 1, 1168),
	(10, '2023-11-09 15:49:31', 6, NULL, 1, 3, 8535),
	...
	(17, '2023-11-12 17:03:41', 8, NULL, 1, 5, 1168),
...
-- Dumping data for table danny-store-db.order_item: ~22 rows (approximately)
...
REPLACE INTO `user` (`id`, `active`, `address`, `avatar`, `created_at`, `gender`, `modified_at`, `name`, `password`, `password_reset_token`, `password_reset_token_expiry_date`, `phone`, `role`, `username`) VALUES
	(1, b'1', 'Nam Dinh', 'None', '2023-10-11 13:41:14', '1', NULL, 'Long', '$2a$10$.mHniwHnIa0QrR.UXC4Y4.c2gAA6/mFmCbJg3to28SGxJaJbb1HPm', NULL, NULL, '1234567890', 'admin', 'admin@gmail.com'),
	...
	(8, b'1', 'Hải Dương', NULL, '2023-11-11 10:25:47', '0', NULL, 'Ngố Thị Lanh', '$2a$10$NZ0td7SxR8QczEMwBskyOuEF7QFOJ0gnBMi5xgsZbX9rrXJ.eU.Uy', NULL, NULL, '0329735190', 'admin', 'LanhNgao');
